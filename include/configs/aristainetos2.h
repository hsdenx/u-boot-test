 ...
 *
 * Configuration settings for the aristainetos board
 */
...
#define CONFIG_EXTRA_ENV_BOARD_SETTINGS \
	"board_type=aristainetos2b_7@1\0" \
...
#define CONFIG_EXTRA_ENV_BOARD_SETTINGS \
	"board_type=aristainetos2b_csl_7@1\0" \
	"dead=led led_red on; i2c dev 2; i2c mw 20 7.1 0xEF;" \
		"i2c mw 20 3.1 0xEF\0" \
	"mtdids=nand0=gpmi-nand,nor0=spi0.0\0" \
	"mtdparts=mtdparts=spi0.0:832k(u-boot),64k(env),64k(env-red)," \
		"-(ubi-nor);gpmi-nand:-(ubi)\0" \
	"addmisc=setenv bootargs ${bootargs} net.ifnames=0 consoleblank=0 " \
...
#define CONFIG_EXTRA_ENV_BOARD_SETTINGS \
	"board_type=aristainetos2c_7@1\0" \
	"emmcpart=1\0" \
...
#define CONFIG_ARP_TIMEOUT		8000UL
